...
export const TOUR_STEPS: TourStepSpec[] = [
  ...
  },
  {
    ...
    title: "Your match",
    body: "How well your resume fits this posting: green from 80, amber from 60, red from 40. A ~ means it's still an estimate — every posting is checked line by line against your resume in the background.",
    side: "right",
    needsResume: true,
    optional: true,
  },
  ...
  },
  {
    ...
    body: "Match breakdown goes through the posting line by line: which lines your resume meets, and the line of your resume that shows it. Next opens it.",
    side: "bottom",
    desktopOnly: true,
    inDetail: true,
    needsResume: true,
